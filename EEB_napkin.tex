...
\input{TeX/head.tex} %some useful packages and custom commands
...
\begin{document}
	\begin{titlepage}
		\begin{center}
			...
			\large
			\vspace{-0.2cm}\text{Ananda Shikhara Bhat}
		\end{center}
	\end{titlepage}
	\tableofcontents
	\part{Evolutionary Game theory and adaptive dynamics}
	\include{TeX/EGT_for_mathematicians}
	\include{TeX/Adaptive_dynamics}
	\include{TeX/Adaptive_diversification_intro}
	\part{Evolution in finite populations}
	\include{TeX/b_d_proceses}
	\part{Spatial ecology and random walks}
	\include{TeX/random_walks_and_diffusion_approximations}
	\include{TeX/Turing_instabilities}
%Bibliography
